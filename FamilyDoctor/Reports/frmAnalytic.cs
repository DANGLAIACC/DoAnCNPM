...
namespace GUI.Reports
{
    public partial class frmAnalytic : Form
    {
        ...
        public frmAnalytic(string Rec_id, string Rec_date, string Rec_diagnostic, string Pat_fullname, string Pat_age, string Pat_address, string Pat_gender, string Doc_fullname, List<Prescription_DTO> lst)
        {
            InitializeComponent(); 
            this.Rec_id = Rec_id;
